...
public class armRightArmors extends equipment {

    private  String partName="右手";
    ...
    public armRightArmors(){}

    public armRightArmors(String armorsName, Materials armorsMaterials, double armors, double magicResistance, double durability,skill skills,Integer gold) {
