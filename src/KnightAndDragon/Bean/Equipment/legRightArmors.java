...
public class legRightArmors extends equipment {

    private String partName = "右腿";
    ...
    public legRightArmors(){}

    public legRightArmors(String armorsName, Materials armorsMaterials, double armors, double magicResistance, double durability, skill skills, Integer gold) {
