...
public class armLeftArmors extends equipment {

    private  String partName="左手";
    ...
    public armLeftArmors(){}

    public armLeftArmors(String armorsName, Materials armorsMaterials, double armors, double magicResistance, double durability, skill skills, Integer gold) {
