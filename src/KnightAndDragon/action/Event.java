...
public class Event {
        ...
        while (true) {
            ...
            switch (b) {
                case 1:
                    ...
                    System.out.println("输入我想买装备的编号\t  -1返回上一层");
    ...
    public void repicOne() {
        System.out.println("我打开了门，里面是一条漆黑的走廊，我小心翼翼的走了进去，来到第一个打大厅");
        System.out.println("大厅的对面有另一道石门，厅的中心有一个石盆，石盆附近有几个人类的尸体，看起来像几个死掉的冒险家，我慢慢的靠近了石盆，只见石盆的下面有字“通往光明的道路上不可避免的会出现牺牲”");
        System.out.println("石盆的底座上有三个孔，孔里的液体早已干涸，我隐约能看出其中一个孔上面有水的痕迹，其他两个看不清楚，看来打开石门的关键是要往石盆里灌满什么东西，只不过此时已经没有了选项");
        System.out.println("我思考了片刻，决定");
        System.out.println("1.观察附近的情况\t2.蛮力攻击石门\t3.离开遗迹");
        Integer b = Utils.Scanner();
        switch (b) {
            case 1:
                System.out.println("我仔细看了看附近人类的尸体，发现他们的身上带着一个喝了一半水的水壶，一个满的油壶，一把小刻刀，一个火把，我仔细想了想，决定往石盆里注入（解密题，输入我想注入的东西）");
                String str = Utils.StringScanner();
                if (str.contains("血")) {
                    System.out.println("我拿起小刻刀，把自己的胳膊划了一个小口，血液流进了石盆里");
                    ...
                    System.out.println("地面上喷出了火焰，我被轰出了遗迹");
    ...
    public void repinTwo() {
        System.out.println("我来到了第二个大厅，对面仍然是一道关闭的大门，这个大厅里面空荡荡的，只有5个人俑并排着站在一起");
        ...
        switch (a) {
            case 1:
                ...
                if (str.equals("3#2#4#1#5")) {
                    ...
                    System.out.println("周围的墙壁轰隆了一声，我下意识的去看门，发现没有打开，四周一股毒气扑面而来，我捂着鼻子狂奔出去，慌乱中，丢失了所有金币");
                    knight.setGold(0);
                    System.out.println("看来这个遗迹是不能进去了，我叹了口气，离开了这里");
                }
                break;
            case 2:
                System.out.println("我观察了一会，突然发现5个人俑裂开了，5个模糊的身影朝我扑来");
                for (int i = 0; i < 4; i++) {
    ...
    public void repicThree() {
        System.out.println("第三个大厅金碧辉煌，中间有一个巨大的宝箱，我欣喜若狂，看来宝物就在这个地方");
        System.out.println("我跑上前去，突然旁边的墙壁动了一下，一个巨大的黑影打了过来");
        enemy enemy = Boss.getInstance().getEnemies().get(2);
        Action.process(knight, enemy);
        System.out.println("我打败了黑龙");
    ...
    @Effect(startNum = "101")
    public void aWoman() {
        System.out.println("“hi，小伙子”，森林前方的一个女人喊住了我");
        System.out.println("我停了下来，打量了一下眼前这个女人，只见她穿着沾满污渍的老旧的羊毛长裙，脸上的皱纹多的让我觉得发毛");
        System.out.println("“我看起来有急事要去做”，这个女人颤颤的说道，“我知道我要去哪，我这里有个东西能帮到我，不过我得花点钱才行”,我凭借着多年的丰富阅历，从她满脸褶皱的脸上发现到了一丝不易察觉的狡猾的微笑");
        System.out.println("1.掏钱  2.忽略她");
        int a = Utils.Scanner();
        switch (a) {
            case 1:
                if (knight.getGold() >= 30) {
                    System.out.println("我拿出了一袋钱，换了她一样东西");
        ...
        switch (a) {
            case 1:
                ...
                if (d <= 0.5) {
                    ...
                    System.out.println("我获得了" + item.getItemName());
            ...
            case 2:
                ...
                Item item = Items.getIssueMap().get(4001);
                System.out.println("我发现哥布林的腰间挂着一把钥匙");
                Backpack.getInstance().putBackpack(item);
                break;
            default:
                break;
    ...
    public void mysteriousMaster() {
        ...
        System.out.println("我摸索着靠了过去，发现是个小木房子，貌似有人居住，我很奇怪，在满是哥布林的森林里，为什么还有人生活");
        System.out.println("看起来可以住，我心想着，打算今晚在这留宿一下");
        System.out.println("1.敲门\t2.离开");
        Integer a = Utils.Scanner();
        switch (a) {
            case 1:
                System.out.println("我敲了敲们，开门的是一个年迈的老先生，留着长长的白胡子，带着一副小圆框眼镜，头上还带着一顶奇怪的高脚帽");
                TimeSleep.timeSleep(500);
                System.out.println("我向他说明了来意，他点点头让我进来，我打量了房子的内部，里面有各种魔法书和魔法道具，看起来是个魔法师的房子");
                TimeSleep.timeSleep(500);
                System.out.println("“放心吧，我在附近设了结界，哥布林看不到这儿，这个森林虽然有点危险，但是确实很安静，不会打扰我研习魔法”，白胡子老先生说，“倒是我”，他看了我一眼说道“这么晚了怎么还会在这”");
                TimeSleep.timeSleep(500);
                System.out.println("我跟他说了一下我的情况，他沉默了一会，低头小声说了一句“看来是真的”，然后他抬起头看着我，说：“既然这样，我就帮我一下吧，我有什么需要我帮我的吗？”");
                TimeSleep.timeSleep(500);
                System.out.println("1.我想学习魔法\t2.我需要更多的技能\t3.我需要取掉身上的一件饰品\t4.只要留宿就好");
                Integer b = Utils.Scanner();
                switch (b) {
                    case 1:
                        System.out.println("白胡子给了我一瓶药水，我喝了下去，感觉魔法能力上升了");
                        System.out.println("魔法攻击力增高1点");
                        knight.setMagicAttack(knight.getMagicAttack() + 1);
                        break;
                    case 2:
                        System.out.println("白胡子朝我年了一句咒语，我觉得精神倍加");
                    ...
                    case 3:
                        ...
                        break;
                    default:
                        System.out.println("既然这样，那我送我一件东西吧");
                        Backpack.getInstance().putBackpack(Items.getItemsMap().get(RandomGetDouble.getInteger(Items.getItemsMap().size())));
                        break;
                }
                System.out.println("第二天，我向白胡子告了别，继续往北前进");
                break;
            default:
                break;
        }
    ...
    public void GoblinBlaksmith() {
        ...
        System.out.println("我走上前一看，是个哥布林武器匠");
        ...
        switch (a) {
            case 1:
                if (RandomGetDouble.randomDecimals() <= 0.5) {
                    ...
                    enemy enemy = enemyList.createEnemyFactory(a);
                    System.out.println("这是个陷阱,我被偷袭了");
                    Action.process(knight, enemy);
                }
                break;
            default:
    ...
    @Effect(startNum = "107")
    public void ACave() {
        System.out.println("涉过一条小河，我来到了一座高山的山脚下");
        System.out.println("在灌木丛茂密的地方，我发现了一个洞穴，看起来好像很久没有人进过了");
    ...
    public void GoblinCave() {
        System.out.println("山爬到了一半，我突然听到附近有什么东西在说话");
        System.out.println("我停了下来，寻找着声音的来源");
        TimeSleep.timeSleep(500);
        System.out.println("拨开一片灌木，我发现前面有两个哥布林");
        ...
        switch (a) {
            case 1:
                ...
                if (d < 0.5) {
                    ...
                    Action.judgeEnemyDeath(enemy1);
                    Action.getDrop();
                    System.out.println("=======================================\n" + enemy2.getEnemyName() + "发现了我");
                    Action.process(knight, enemy2);
                    System.out.println("=======================================\n打败了两个哥布林，我发现在他们身后，有一个一人大小的地洞");
                    GoblinKingdom();
    ...
    public void GoblinKingdom() {
        ...
        if (!Backpack.findItem(4001)) {
            System.out.println("我没有哥布林的钥匙，只好离开了这里");
            return;
        }
        Backpack.getInstance().dropItemFromBackpack(4001, 1);
        System.out.println("我使用了哥布林的钥匙,进到了洞穴里面");
        for (int i = 0; i <= 3; i++) {
            if (i == 0) {
            ...
            if (i == 3) {
                System.out.println("洞穴似乎到尽头了，我加快了脚步，看看周围有什么");
            }
            Double d = RandomGetDouble.randomDecimals();
            if (d <= 0.1) {
                System.out.println("===========");
                ...
                System.out.println("我打败了巡逻小队，从他们身上发现了一样东西");
                TimeSleep.timeSleep(1000);
                Accessories item = Items.getAccessoriesHashMap().get(RandomGetDouble.getAccessories());
                AccessoriesBackPack.getInstance().putAccessories(item);
        ...
        System.out.println("洞穴的尽头是一个大厅，四周挤满了哥布林，大厅的中央有一个巨大的黑影，头顶上戴着类似王冠的恭喜，我看着它，也能发现它正在盯着我\n=================================================");
        enemy enemy = Boss.getInstance().getEnemies().get(0);
        Action.process(knight, enemy);
        Item item = Items.getBossMap().get(RandomGetDouble.getGoblinKing());
        ...
        System.out.println("我顺着洞口继续往前走，阳光从前方的一个小洞透了进来，我走出了哥布林的洞穴");
    }

    //哥布林商人
    @Effect(startNum = "109")
    public void GoblinSaler() {
        System.out.println("我走在森林里，发现前面有一个哥布林，它是一个哥布林行脚商人，似乎对我没有任何敌意");
    ...
    public void moonNight() {
        ...
        TimeSleep.timeSleep(500);
        System.out.println("我刚刚躺下，觉得附近有悉悉索索的声音");
        TimeSleep.timeSleep(500);
        System.out.println("还没等我反应过来，有东西扑了过来");
    ...
    public void robberAndPrecious() {
        System.out.println("“把钱交出来”我的四周里蹦出来一伙强盗");
        ...
        switch (a) {
            case 1:
                ...
                break;
            case 2:
                System.out.println("我谎称之前抢劫了一张藏宝图，里面有巨量的财富，藏宝图需要火焰烘烤才能看见里面的内容");
                System.out.println("于是强盗把我带到了他们的营地，我掏出了一张纸给他们去烘烤，然后偷偷观察附近的环境");
                ...
                if (b == 1) {
                    if (RandomGetDouble.randomDecimals() >= 0.5) {
                        ...
                        System.out.println("我仔细翻找了强盗的营地，发现一个宝箱，打开宝箱获得100g");
                        knight.setGold(knight.getGold() + 100);
                    } else {
                        ...
                        System.out.println("强盗们被打死了");
                        System.out.println("我仔细翻找了强盗的营地，发现一个宝箱，打开宝箱获得200g");
    ...
    public void oneEnd() {
        ...
        TimeSleep.timeSleep(500);
        System.out.println("我决定在这里打听一下女儿的下落");
        TimeSleep.timeSleep(500);
        //武器
        List<equipment> weapons = this.weapons();
        //装备
        ...
        while (true) {
            ...
            switch (number) {
                ...
                case 6:
                    System.out.println("================================================================");
                    System.out.println("我不停的询问着每一个过路人，几乎所有人都说不知道，我沮丧的走进了酒馆，朝着酒保点了一杯酒，闷头喝了起来");
                    System.out.println("隐约间，我听到旁边桌上，有个人提到了萨尔莫斯，女孩等字眼");
                    TimeSleep.timeSleep(1000);
                    System.out.println("我一下子精神了起来，仔细听着他们的对话");
                    System.out.println("“我知道吧，就是西边的那过来的那个人”隔壁桌穿褐色袍子的一个人抿了一口酒，说道“听说他在黑暗之地，见到了一个人”");
                    System.out.println("“谁啊”，旁边的人问道");
                    TimeSleep.timeSleep(500);
                    System.out.println("“我听过一千年前的那个传说吗？就是那个当初奇洛亚大陆差点毁灭的传说”褐袍的人压低了声音说道，“传说有个人类与精灵的混血儿，从小就天赋异禀，可惜后来走上了邪恶的道路，他建立了暗影之国，大举入侵其他国家，利用他的黑暗力量操控着被他统治的人，当时整个奇洛亚大陆几乎都被他统治了，最后还是东边的一个公主牺牲生命封印了才拯救了奇洛亚大陆上的其他生命”");
                    TimeSleep.timeSleep(500);
                    System.out.println("“我说的是那个叫萨尔什么什么的魔王吗”，旁边的人惊讶道，“难道他又回来了！”");
                    System.out.println("“嘘，小声点”,然后他们再一次压低了声音，交头接耳的嘀咕着什么");
                    TimeSleep.timeSleep(500);
                    System.out.println("我听到这，实在忍不住了，放下手中的酒杯，大步走向褐袍人，还没等他反应过来，一把揪住了他的领子，让他把整个事情说清楚");
                    System.out.println("褐袍人吓了一跳，慌慌张张的说道具体他也不知道，他只是听其他人说的，听说最近萨尔莫斯派手下在大陆上寻找6-7岁的蓝瞳女孩，只要符合条件的女孩全部被抓走了");
                    TimeSleep.timeSleep(500);
                    System.out.println("我问他这些抓到什么地方去了，褐袍人结结巴巴的说最近在北方矮人的金矿镇有人看见过萨尔莫斯的爪牙们经常前往那里，其他的他就不知道了");
                    System.out.println("我松开了褐袍人的领子，金矿镇，看来有目标了");
                    System.out.println("想到这里，我背起背包，大步的离开了酒吧\n================================================================");
                    TimeSleep.timeSleep(500);
                    break;
                default:
                    return;
    ...
    @Effect(startNum = "201")
    public void ferry() {
        System.out.println("前面是一条穿过森林的小河" + knight.getKnightName() + "走到了河边，我四处张望了一下，发现并没有桥可以让我过去，但是河面上有个小木筏，木筏上貌似有人，我决定\n1、喊船上的人，让他载我过去\t2、游过去\n3、观察水面");
        int a = Utils.Scanner();
        switch (a) {
            case 1:
                System.out.println("船划了过来，是个打渔的渔夫，把我带到河中央的时候，向我索要报酬");
                if (knight.getGold() - 10 * knight.getLevel() >= 0) {
                    ...
                    System.out.println("我身上钱不够，被渔夫扔下了船，全体血量扣减一半");
                }
                break;
            case 2:
                System.out.println("游到河中央，碰到了暗流，我被暗流卷进去，砸到了头，头减少30点血量");
                knight.setHead(knight.getHead() - 30 >= 1 ? knight.getHead() - 30 : 1);
                break;
            default:
                enemy enemy = enemyList.createEnemyFactory(1);
                System.out.println("我犹豫了，碰到了巡逻的怪物" + enemy.getEnemyName());
                TimeSleep.timeSleep(500);
                Action.process(knight, enemy);
                break;
        }
    ...
    public void helpFarmers() {
        System.out.println("前方是一片农田，正是丰收的季节，有个农夫要赶在黑暗来临之前把忙做了一年的麦子给收掉，我决定\n1、帮助他\t2、无视他");
        int a = Utils.Scanner();
        switch (a) {
            case 1:
                ...
                while (true) {
                    if (item != null) {
                        System.out.println("我和农夫很快收完了麦子，农夫为了感谢我，给了我" + item.getItemName());
                        Backpack.getInstance().putBackpack(item);
                        break;
                    } else {
    ...
    public void equipmentSaler() {
        ...
        switch (b) {
            case 1:
                ...
                break;
            default:
                System.out.println("我摇了摇头，从他们身边走了过去");
                break;
    ...
    public void relic() {
        ...
        System.out.println("我靠了过去，发现是一片上古遗迹");
        System.out.println("遗迹里面有几个哥布林的尸体，看起来遗迹很危险，我决定");
        System.out.println("1.下去看看\t2.离开");
        Integer b = Utils.Scanner();
        switch (b) {
            case 1:
                System.out.println("下面有一道带锁的石门挡在了我的面前");
    ...
    public void aVillage() {
        ...
        System.out.println("我沿着路进到了村庄，村庄面积不大，却很热闹，村里有一个铁匠铺");
        List<equipment> equipment = this.equipments();
        while (true) {
    ...
    public void sliverTown() {
       System.out.println("在通往金矿镇的路上，一座高耸入云的山挡住了我的去路，山脚下，有一座几乎被废弃了的矮人小镇--银矿镇");
       System.out.println("过去的银矿镇大量生产银矿，各地的人们来这采购各种银制品，繁荣程度丝毫不亚于格尔里斯，现在的银矿镇，除了镇长，几乎都只剩下老弱病残了");
       System.out.println("我抬头看了看这座雪山，觉得翻过去是不可能的了，看来只能找镇长问一问其他出路了");
       System.out.println("我找到镇长，跟他说明缘由之后，镇长眉头皱了皱，说道“路倒是有一条，过去银矿镇开采银矿的时候留下的矿洞，直通山的另一面，不过后来有条恶龙盘踞在了哪里，之后没人敢再进去过”");
       System.out.println("“除此之外，也没有其他的路了”");
       System.out.println("听完镇长的话，我咬了咬牙，时间紧迫，看来这个洞是非进不可了，我问清了矿洞的位置，开始朝矿洞走去。。");
    }
    ...
    public void fightToDragon(){
        TimeSleep.timeSleep(500);
        System.out.println("走了一段路之后，我来到了镇长所说的那个矿洞，里面漆黑一片，不时有尖锐的风声从里面传来，让人不寒而栗");
        TimeSleep.timeSleep(500);
        System.out.println("我掏出火把，摸了摸额头的冷汗，摸着矿道的墙壁，走了进去");
        TimeSleep.timeSleep(500);
        System.out.println("走了大概十分钟左右，除了火把的光亮，已经彻底看不见其他东西了，我咽了口唾沫，耳边传来叽叽的声音，直觉告诉我黑暗中有什么东西在盯着我，果然，还没等我反应过来，有东西就扑了过来");
        for (int i=0;i<=2;i++){
            enemy enemy=enemyList.getEnemyDragonList().get(3);
            Action.process(knight,enemy);
        }
        TimeSleep.timeSleep(1500);
        System.out.println("耳边的声音消失了，我来到了一个岔路口");
        System.out.println("1.走左边\t2.走右边");
        Integer a=Utils.Scanner();
        switch (a){
            case 2:
                System.out.println("我发现了一个废旧的手动矿车，看起来还能用，也许可以利用它加快速度");
        ...
        System.out.println("乘着矿车前进了10分钟，我来到了一个巨大的深坑边缘，深坑的地步有一只巨大的黑龙，黑龙嗅到了我的气味，巨大的翅膀张了开，炽热的火焰朝我喷了过来，砸到了顶部的矿壁");
        TimeSleep.timeSleep(1500);
        ...
        TimeSleep.timeSleep(1500);
        System.out.println("解决了这条龙，我加快了矿车的速度，远处的光点逐渐变大，一瞬间，我出了矿道");
    ...
    public void thedwarfMerchants() {
        System.out.println("======================================================");
        System.out.println("在一个独木桥，我遇到了一个矮人族的游行商人");
